...
@CucumberOptions(
        ...
        glue = {"StepDefinition"},
        tags = {"@allTestcase"},
//        plugin = {"html:target/cucumber-report/Report.html","json:target/cucumber-report/Report.json"},
        plugin = {"com.cucumber.listener.ExtentCucumberFormatter:target/cucumber-report/reportMidtrans.html"},
...
public class RunnerTest {
    ...
    public static void writeExtentReport() {
        ...
        Reporter.setSystemInfo("Website ","Midtrans-Pillow");
    }
}
